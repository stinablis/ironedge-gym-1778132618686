...
const basePath = '/ironedge-gym-1778132618686';
...
export default function Home() {
  ...
  const products = [{ n: 'Personal Training', d: '1-on-1 sessions with certified coaches', i: 'https://images.pexels.com/photos/6922119/pexels-photo-6922119.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Group Classes', d: 'HIIT, yoga, and spin classes daily', i: 'https://images.pexels.com/photos/6339349/pexels-photo-6339349.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Monthly Membership', d: 'Unlimited gym access 24/7', i: 'https://images.pexels.com/photos/4553611/pexels-photo-4553611.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Nutrition Plan', d: 'Custom meal plan by our dietitian', i: 'https://images.pexels.com/photos/8844383/pexels-photo-8844383.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Online Coaching', d: 'Remote training program with weekly check-ins', i: 'https://images.pexels.com/photos/6339716/pexels-photo-6339716.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">IronEdge Gym</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/6388373/pexels-photo-6388373.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Push beyond your <span className="text-accent">limits..</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              IronEdge Gym delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60123456789`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At IronEdge Gym, we are dedicated to empowering individuals to reach their full potential through tailored fitness programs and expert coaching. Our state-of-the-art facilities and supportive community foster a culture of discipline and results-driven training. By pushing beyond their limits, our members achieve transformative results and a lifelong commitment to wellness.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the premier fitness destination, renowned for delivering exceptional training experiences and inspiring a community of like-minded individuals to achieve unparalleled success.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide personalized, results-driven fitness solutions that educate, motivate, and support our members in achieving their unique goals and embracing a healthy, balanced lifestyle.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Discipline</h4>
                  <p className="text-sm text-on-surface-variant">Consistency builds champions.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Results</h4>
                  <p className="text-sm text-on-surface-variant">Every session gets you closer to your goal.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/5878669/pexels-photo-5878669.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/6339485/pexels-photo-6339485.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/7174396/pexels-photo-7174396.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">info@ironedgegym.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">IronEdge Gym</div>
            <p className="text-white/60 text-sm leading-relaxed">Push beyond your limits.</p>
          </div>
          ...
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              © {new Date().getFullYear()} IronEdge Gym. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
